...
# -*- coding: utf-8 -*-
"""
Created on Sun May 16 14:13:15 2021

@author: montikachaikittiporn
"""
...
class SeperateChaining:
    ...
    table,size = [],0
    load_factor = 2;
    def __init__(self,m): self.table = [None]*m;
...
test.put("name","Skitty1");
test.put("name2","Skitty2");
test.put("name3","Skitty3");
